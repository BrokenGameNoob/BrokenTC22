...
#define DS_ELEM_ACCESSOR_DECL(                                                                  \
    type, name, editor_group, editor_type, editor_title, game_compatibility, display_condition) \
  ...
  class ClassName : public QObject {                                                                                 \
   ...
   public:                                                                                                           \
    ...
    bool ReloadFromFile() {                                                                                          \
      ...
      std::cout << "Reloaded from file <" << #ClassName << ">{{" << DebugString().toStdString() << "}" << std::endl; \
      return kSuccess;                                                                                               \
    }                                                                                                                \
   ...
   private:                                                                                                          \
    void InternalOnChange() {                                                                                        \
      ...
      SPDLOG_DEBUG("Saved on change <{}>{{{}}} to\n{}", #ClassName, DebugString(), m_m_save_path);                   \
    }                                                                                                                \
  };                                                                                                                 \
